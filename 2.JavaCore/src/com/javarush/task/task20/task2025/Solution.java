...
public class Solution {
    ...
    public static long[] getNumbers(long maxNumber) {

        List<Long> numbers = generate(20);

        for (int i = numbers.size() - 1; i >= 0; i--) {
            if (numbers.get(i) >= maxNumber) numbers.remove(i);
        }

        long[] result = numbers.stream().mapToLong(l -> l).toArray();
    ...
    public static void main(String[] args)  throws IOException {
        ...
        long[] list =  getNumbers(9223372036854775807L);
